...
# inputDF = glueContext.create_dynamic_frame.from_catalog(database="nsw_data", table_name="realestate1799", transformation_ctx="inputDF")
...
inputDF = glueContext.create_dynamic_frame.from_catalog(
    database="nsw_data",  # Replace with your database name
    table_name="realestate1799",  # Replace with your table name
    transformation_ctx="inputDF"
)
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://realestate1799/temporary/",  # Replace with your S3 path for temporary data
        "useConnectionProperties": "true",
        "dbtable": "public.nsw_properties",  # Replace with your Redshift table name
        "connectionName": "jdbc1"  # Replace with your Glue connection name for Redshift
    },
    transformation_ctx="AmazonRedshiftDF"
)
